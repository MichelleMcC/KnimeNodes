...
import com.webbres.knime.reporting.email.functionality.SendMailAttachment;
import com.webbres.knime.reporting.email.functionality.SendMailHtml;
import com.webbres.knime.reporting.email.functionality.SendMailSimple;
import com.webbres.knime.reporting.email.functionality.TableToHTML;
 ...
 * @author WebbRes
 */
public class CreateAndSendHtmlNodeModel extends NodeModel 
{
    ...
    static final String attachment = "attachment";		// attachment
	
    int numOutCols = 6; // host, port, to, subject, body
    ...
    private final SettingsModelString m_attachment = new SettingsModelString(attachment, "");
    
    
    // Node Logger
	private static final NodeLogger logger = NodeLogger.getLogger(CreateAndSendHtmlNodeModel.class);
    
    /**
     * Constructor for the node model.
     */
    protected CreateAndSendHtmlNodeModel() 
    {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final ExecutionContext exec) throws Exception 
    {
	    ...
	    // Compile HTML
    	String htmlTable = TableToHTML.convertToHtml(table); // we now have the HTML table
    	String givenText = m_body.getStringValue();
    	...
    	try 
    	{
			...
			SendMailHtml newMail = new SendMailHtml(m_host.getStringValue(), m_port.getIntValue());
			...
			newMail.setupMail(m_username.getStringValue(), sendTo, m_subject.getStringValue(), html);
			
			if(m_attachment != null)
			{
				String fileName = new File(m_attachment.getStringValue()).getName();
				
				exec.setMessage("Attaching file");
				newMail.addAttachment(m_attachment.getStringValue(), "", fileName);
			}
		...
		cells[4] = new StringCell(html);
		cells[5] = new StringCell(m_attachment.getStringValue());
    ...
    protected void saveSettingsTo(final NodeSettingsWO settings) 
    {
         ...
         m_attachment.saveSettingsTo(settings);
    }
    ...
    protected void loadValidatedSettingsFrom(final NodeSettingsRO settings) throws InvalidSettingsException 
    {
        ...
        m_attachment.loadSettingsFrom(settings);
    }
    ...
    protected void validateSettings(final NodeSettingsRO settings) throws InvalidSettingsException 
    {
        ...
        m_attachment.validateSettings(settings);
    }
    ...
    public DataTableSpec createTableSpec()
    {
		...
		allColSpecs[5] = new DataColumnSpecCreator("Filepath", StringCell.TYPE).createSpec();
