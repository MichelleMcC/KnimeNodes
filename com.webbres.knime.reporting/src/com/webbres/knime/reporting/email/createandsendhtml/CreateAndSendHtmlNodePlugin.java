 ...
 * @author WebbRes
 */
public class CreateAndSendHtmlNodePlugin extends Plugin {
    // The shared instance.
    private static CreateAndSendHtmlNodePlugin plugin;

    /**
     * The constructor.
     */
    public CreateAndSendHtmlNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CreateAndSendHtmlNodePlugin getDefault() {
        return plugin;
    }
