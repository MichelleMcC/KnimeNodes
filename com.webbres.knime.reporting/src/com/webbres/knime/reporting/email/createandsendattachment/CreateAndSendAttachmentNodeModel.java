 ...
 * @author WebbRes
 */
public class CreateAndSendAttachmentNodeModel extends NodeModel 
{
    ...
    // Node Logger
	private static final NodeLogger logger = NodeLogger.getLogger(CreateAndSendAttachmentNodeModel.class);
    
    /**
     * Constructor for the node model.
     */
    protected CreateAndSendAttachmentNodeModel() 
    {
    ...
    protected BufferedDataTable[] execute(final BufferedDataTable[] inData, final ExecutionContext exec) throws Exception 
    {
    	...
    	try 
    	{
			...
			SendMailAttachment newMail = new SendMailAttachment(m_host.getStringValue(), m_port.getIntValue());
