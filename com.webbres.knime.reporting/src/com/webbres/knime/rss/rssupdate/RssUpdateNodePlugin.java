 ...
 * @author Sam Webb
 */
public class RssUpdateNodePlugin extends Plugin {
    // The shared instance.
    private static RssUpdateNodePlugin plugin;

    /**
     * The constructor.
     */
    public RssUpdateNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RssUpdateNodePlugin getDefault() {
        return plugin;
    }
