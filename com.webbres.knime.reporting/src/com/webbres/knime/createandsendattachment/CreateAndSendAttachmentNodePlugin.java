 ...
 * @author WebbRes
 */
public class CreateAndSendAttachmentNodePlugin extends Plugin {
    // The shared instance.
    private static CreateAndSendAttachmentNodePlugin plugin;

    /**
     * The constructor.
     */
    public CreateAndSendAttachmentNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CreateAndSendAttachmentNodePlugin getDefault() {
        return plugin;
    }
