 ...
 * @author WebbRes
 */
public class CreateAndSendNodePlugin extends Plugin {
    // The shared instance.
    private static CreateAndSendNodePlugin plugin;

    /**
     * The constructor.
     */
    public CreateAndSendNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static CreateAndSendNodePlugin getDefault() {
        return plugin;
    }
