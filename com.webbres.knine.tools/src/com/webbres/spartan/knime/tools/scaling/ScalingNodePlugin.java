 ...
 * @author Sam Webb
 */
public class ScalingNodePlugin extends Plugin {
    // The shared instance.
    private static ScalingNodePlugin plugin;

    /**
     * The constructor.
     */
    public ScalingNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ScalingNodePlugin getDefault() {
        return plugin;
    }
